...
```bash
curl https://raw.githubusercontent.com/Flippecho/jsproxy/0.1.0/i.sh | bash
```
...
```bash
curl https://raw.githubusercontent.com/Flippecho/jsproxy/master/i.sh | bash -s example.com
```
